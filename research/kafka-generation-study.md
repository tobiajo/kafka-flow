...
## Appendix: PR-review dispositions (the generation-refresh discussions)

*(Folded in from the former standalone dispositions file — the closure record for the generation-refresh PR review, upstream #843. Every argued thread with its terminal disposition, so none needs relitigating.)*
